  ...
  return (
    <div className="navbar navbar-dark bg-dark justify-content-between m-auto sticky-top">
      <div className="container">
        <h5 className="pointer header-text my-auto text-white" onClick={() => props.setView('catalog', {})}>
          <i className="fas fa-gamepad"></i> Game Bay Shop
        </h5>
        <h6 className="pointer my-auto mr-3 text-white" onClick={() => props.setView('cart', {})}>
